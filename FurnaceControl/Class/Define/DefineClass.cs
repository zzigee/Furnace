...
namespace FurnaceControl
{
    internal class DefineClass
    {
        ...
        //public int nDangjinThermalCalPeriod = 500;
        ...
        public struct ST_BILLET_INFOMATION
        {
            ...
            public float nBillet_Charge_Temperature;                        // 빌렛 장입온도
            public float nBillet_Discharge_Target_Temperature;              // 빌렛 목표 배출 온도    
            public float nBillet_Predict_Discharge_Billet_Temperature;      // 빌렛 예상 배출 온도
            public float nBillet_Predict_Current_Billet_Temperature;        // 현재 빌렛 예상 온도
            public float nBillet_Predict_Current_Billet_Temperature_304;        // 현재 빌렛 예상 온도
            public float nBillet_Predict_Current_Billet_Temperature_400;        // 현재 빌렛 예상 온도
            ...
            public float nZone_Average_Temperature;                         // 존 평균 온도 
        }
